...
import { GrayP, TwSpan, TwTitle_MD } from '../Material/Material'
import ListExpert from './ListExpert/ListExpert'

const ProfessionalTeams = () => {
    const TeamsContainer = tw.div`max-w-[67.813rem] mx-auto pt-[8.8rem] lg:max-w-full lg:px-[8%] md:pt-[22rem] sm:pt-[16rem] xs:pt-0`
