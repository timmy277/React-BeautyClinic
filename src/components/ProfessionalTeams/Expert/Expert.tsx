...
const Expert = (props: {
  ...
  const ExpertContainer = styled.div<{ special: boolean }>(({ special }) => [
    ...
    special &&
      tw`bg-white shadow-md max-w-[26.5rem] w-[26.5rem] pb-[4.7rem] pt-[5.8rem] mt-[-5.8rem] md:shadow-none sm:shadow-none`,
  ]);
  ...
  const ExpertDescription = tw(
    GrayP
  )`mb-[2.4rem] max-w-[16.875rem] text-center tracking-[0.09rem] text-sm font-normal leading-[1.313rem] md:max-w-[70%] sm:max-w-[70%]`;
