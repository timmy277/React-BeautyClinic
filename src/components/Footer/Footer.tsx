...
const Footer = () => {
    const FooterWrapper = tw.div`max-w-full h-[44.084rem] flex bg-FooterBG bg-center-bottom bg-no-repeat mt-[4.3rem] pt-[14rem] 2xl:bg-top-bottom 2xl:bg-cover-contain xl:bg-top-bottom xl:bg-cover-contain md:pt-[10rem] sm:pt-[10rem]`
        ...
        <FooterWrapper>
            <FooterContainer>
                ...
                <BottomFooter>
                    ...
                    <p tw="text-base font-normal tracking-[0.105em]">© AltDesain Studio 2021 - All right reserved.</p>
                </BottomFooter>
            </FooterContainer>
        </FooterWrapper>
    )
