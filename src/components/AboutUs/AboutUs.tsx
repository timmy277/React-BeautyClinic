...
const AboutUs = () => {
    ...
    const GroupButton = tw.div`flex flex-row justify-between max-w-[26.75rem] md:gap-[2rem] md:max-w-[80%] md:px-[10%] md:py-[2%] sm:gap-[1rem] sm:max-w-full sm:px-[6%] sm:py-[2%] xs:max-w-full text-nowrap`
