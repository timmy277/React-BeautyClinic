...
const Vision = () => {
    ...
    const VisionImage = tw.img`w-[23.344rem] h-[14.691rem] md:w-full md:max-w-full md:h-auto md:mx-auto  sm:w-full sm:max-w-full sm:mx-auto sm:h-auto`
    ...
    const VisionTitle = tw(TwTitle_MD)`mb-[0.8rem] tracking-[0.01rem]`
