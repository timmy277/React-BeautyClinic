...
const Slogan = () => {
  ...
  const SloganTitle = tw(
    TwTitle_MD
  )`text-white max-w-[40%] mb-[1.2rem] lg:max-w-[50%] md:max-w-[70%] sm:max-w-[70%]`;
  const SloganDescription = tw(
    GrayP
  )`text-sink_gray max-w-[48%] lg:max-w-[60%] md:max-w-[70%] sm:max-w-[70%]`;
  return (
    <>
      <SloganContainer>
        <SloganBGWrapper>
