...
const Question = () => {
    const QuestionContainer = tw.div`max-w-[60.75rem] mx-auto pt-[7.3rem] mb-[7.3rem]`
    ...
    const Answer = tw.p`font-poppins text-light_gray font-normal italic text-sm leading-[1.313rem] md:text-xs sm:text-xs max-w-[90%] tracking-[0.094rem] mb-[2.2rem]`
    const QuestionP =tw(GrayP)`text-dark_blue ml-[2.2rem]` 
    const ArrowWrapper = tw.div`mr-[1.2rem]`
    return (        
        <>
            <QuestionContainer>
