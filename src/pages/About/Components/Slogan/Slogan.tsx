...
const Slogan = () => {
    ...
    const SloganSpan = tw(TwSpan)`text-[#ABB4FF] mb-[0.7rem]`
    const SloganTitle = tw(TwTitle_MD)`text-white max-w-[40%] mb-[1.2rem] lg:max-w-[50%] md:max-w-[70%] sm:max-w-[70%]`
    const SloganDescription = tw(GrayP)`text-sink_gray max-w-[48%] lg:max-w-[60%] md:max-w-[70%] sm:max-w-[70%]`
    return (
        <>
            <SloganContainer>
                <SloganBGWrapper>
                ...
                <SloganText>
                    ...
                    <SloganTitle>Best responsibility and service for our customers</SloganTitle>
                    <SloganDescription>Lorem ipsum dolor sit amet, consectetur adipiscing elit ut aliquam, purus sit amet luctus venenatis</SloganDescription>
                </SloganText>
            </SloganContainer>
        </>
    )
