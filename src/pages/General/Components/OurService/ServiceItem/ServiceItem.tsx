...
const ServiceItem = (props:{img: string, name : string, description : string}) => {
    ...
    const ServiceDescription = tw(GrayP)`text-center font-normal text-sm leading-[1.313rem] tracking-widest max-w-[17.125rem] md:max-w-[90%] sm:max-w-[90%] `
    return (
        <ServiceItemWrapper>
            <ServiceImageWrapper>
