...
import { TwButton, TwTitle_LG, BlueP } from "../../../components/Material";
...
const Slider = () => {
  ...
  const SliderTitle = tw(
    TwTitle_LG
  )` mb-[0.5rem] mt-[-1.2rem] tracking-[0.018rem]`;
  const SliderDescription = tw(BlueP)`mb-[2rem]`;
  const DetailButton = tw(
    TwButton
  )`pt-[1.123rem] pr-[2.5rem] pb-[1.141rem] pl-[2.563rem] md:mx-auto md:px-[10%] md:py-[2%] sm:mx-auto sm:px-[6%] sm:py-[2%] tracking-[0.11rem]`;
