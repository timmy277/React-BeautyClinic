...
const BlogHome = () => {
    ...
    const HomeTitle = tw(TwTitle_MD)`text-white max-w-[50%] mx-auto ml-[9.3rem] mb-[-0.4rem] tracking-[0.013rem] 2lg:ml-auto lg:ml-auto md:mb-[0.8rem] md:ml-auto sm:mb-[0.4rem] sm:ml-auto xs:ml-auto xs:mb-0 xs:max-w-[80%]`
    const HomeP = tw(GrayP)`font-medium text-[#D9D9D9] mr-[9.2rem] mt-[0.2rem]`
    return (
        <>
        <HomeBackground>
                <div tw='-z-10'>
