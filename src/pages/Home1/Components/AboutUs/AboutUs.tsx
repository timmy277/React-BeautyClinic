...
const AboutUs = () => {
    ...
    const GroupButton = tw.div`flex flex-row justify-between max-w-[26.75rem] md:gap-[2rem] md:max-w-[80%] md:px-[10%] md:py-[2%] sm:gap-[1rem] sm:max-w-full sm:px-[6%] sm:py-[2%] xs:max-w-full xs:m-0 xs:px-[0%] text-nowrap`
    const ButtonLearnMore = tw(TwButton)`pt-[1.023rem] pb-[1.041rem] pl-[3.063rem] pr-[2.9rem] shadow-sm xs:px-8 xs:py-0.5 `
    const ButtonWatchVideo = tw.div`flex flex-row items-center `
    const ButtonPlay = tw.img`mr-[0.5rem] xs:mr-0`
