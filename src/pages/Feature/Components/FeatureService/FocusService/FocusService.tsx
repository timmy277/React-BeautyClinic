...
const FocusService = (props:{img: string, name : string, description : string}) => {
    ...
    const ServiceDescription = tw(GrayP)`font-normal text-sm leading-[1.313rem] tracking-widest  mb-[1.1rem] md:max-w-[90%] md:text-center sm:max-w-[90%] sm:text-center`
    return (
        <ServiceItemWrapper>
            <ServiceImageWrapper>
