...
const FocusService = (props:{img: string, name : string, description : string}) => {
    const ServiceItemWrapper = tw.div`flex flex-col border border-solid border-[#9BA2E0]  max-w-[16.313rem] max-h-[18.938rem] w-full h-full bg-white px-[2.25rem] pt-[1.938rem] pb-[4.25rem] shadow-md rounded-[1.563rem] mx-auto md:max-w-[100%] sm:max-w-[100%] `
