...
const News = (props:{img: string, title : string, description : string}) => {
    ...
    const NewTitle = tw(TwTitle_SM)`max-w-[85%] mb-[0.9rem] ml-[2.438rem] 2lg:max-w-full 2lg:mx-[6%] lg:max-w-full lg:mx-[6%] md:ml-0 md:text-center sm:max-w-[90%] sm:ml-0 sm:text-center`
    const NewDescription = tw(GrayP)`max-w-[75%] font-normal text-sm leading-[1.313rem] tracking-widest ml-[2.438rem]  mb-[1.7rem] 2lg:max-w-full 2lg:mx-[6%] lg:max-w-full lg:mx-[6%] md:max-w-[90%] md:ml-0 md:text-center sm:max-w-[90%] sm:ml-0 sm:text-center`
    return (
        <NewWrapper>
            <NewImageWrapper>
            ...
            <div tw='flex '>
                <p tw='font-semibold text-sm leading-[1.094rem] text-light_pink font-poppins ml-[2.438rem] mr-[0.6rem] 2lg:ml-[6%] lg:ml-[6%] md:ml-0 sm:ml-0'>Learn more</p>
