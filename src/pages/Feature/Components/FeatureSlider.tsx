...
const FeatureSlider = () => {
  ...
  const SliderTitle = tw(
    TwTitle_LG
  )` mb-[0.8rem] tracking-[0.018rem] text-white`;
  const SliderDescription = tw(
    BlueP
  )`mb-[2.5rem] text-dark_white md:w-[80%] md:mx-auto md:mb-[1.5rem] sm:mb-[1rem] sm:w-[80%] sm:mx-auto`;
  const DetailButton = tw(
    TwButton
  )`bg-transparent max-h-[3.25rem] border border-white border-solid rounded-[0.938rem] pt-[0.875rem] 
