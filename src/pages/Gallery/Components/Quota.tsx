...
const Quota = () => {
    ...
    const QuotaButton = tw(TwButton)`mr-[3.6rem] pt-[1rem] pr-[3.2rem] pb-[1.1rem] pl-[3.4rem] lg:mr-[2.5rem] md:mx-auto md:w-full md:max-w-full md:px-[5%] sm:mx-auto sm:max-w-full sm:w-full sm:px-[5%] xs:max-w-none xs:text-[0.5rem] xs:py-[6%] xs:mx-auto xs:min-w-[130px]`
    return (
        <>
