...
const Footer = () => {
    ...
    const ContactLi = tw.li`list-none list-image-vector  ml-[-0.063rem] font-poppins text-base leading-6 tracking-widest font-normal md:text-sm sm:text-xs text-dark_white pl-[0.313rem] mb-[0.7rem]`
