...
const Header = () => {
  ...
  const HomeItem = tw(
    NavItem
  )`2lg:ml-[7%] lg:ml-[7%] ml-[8.8rem] relative after:absolute after:content-[""] after:w-20 after:h-6 after:right-0 after:top-5`;
  ...
  const ContactButton = styled(TwButton)<{ active: boolean }>(({ active }) => [
    tw`font-medium 2lg:ml-[2%] lg:ml-[2%]`,
    active && tw`font-semibold text-light_blue`,
  ]);
  ...
  const logo =
    location.pathname === "/Feature"
      ? "src/pages/Feature/image/others/FeatureLogo.png"
      : "src/assets/website/MainLogo.png";
  console.log(logo);
